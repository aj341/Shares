...
export const SECTOR_BY_TICKER: Record<string, string> = {
  ...
  // --- Diversification candidates (2026-06-25) ---
  VLO: "Energy",
  LNG: "Energy",
  VG: "Energy",
  EXE: "Energy",
  ...
  MP: "Materials / Mining",
  SCCO: "Materials / Mining",
  FCX: "Materials / Mining",
  AEM: "Materials / Mining",
  CDE: "Materials / Mining",
  HL: "Materials / Mining",
  UUUU: "Materials / Mining",
  ALB: "Materials / Mining",
  GEV: "Industrials",
  VRT: "Industrials",
  ETN: "Industrials",
  PWR: "Industrials",
...
export const ETF_BY_SECTOR: Record<string, string> = {
  ...
  "Consumer / Retail": "XLP",
  "Defense / SaaS": "XLI",
  // --- Diversification sectors (2026-06-25) ---
  "Energy": "XLE",
  "Uranium / Nuclear": "URA",
  "Financials": "XLF",
  "Healthcare": "XLV",
